...
class RandAugment:
    ...
    def __init__(self, n=2, m=5, num_bins=10, random=True, augment_list=None):
        ...
        self.augment_list = [(AutoContrast, None, None),
                             (Brightness, 0.05, 0.95), (Color, 0.05, 0.95),
                             (Contrast, 0.05, 0.95), (Equalize, None, None),
                             (Identity, None, None), (Posterize, 4, 8),
                             (Rotate, 0.0, 30.0), (Sharpness, 0.05, 0.95),
                             (ShearX, 0.0, 0.3), (ShearY, 0.0, 0.3),
                             (Solarize, 0.0, 256.0), (TranslateX, 0.0, 0.3),
                             (TranslateY, 0.0,
                              0.3)] if augment_list is None else augment_list
